...
export interface AIAnalysis {
    overall: { winner: string; reasoning: string };
    gaming: { winner: string; reasoning: string };
    photography: { winner: string; reasoning: string };
    value: { winner: string; reasoning: string };
    dailyUse: { winner: string; reasoning: string };
    summary: string;
}
